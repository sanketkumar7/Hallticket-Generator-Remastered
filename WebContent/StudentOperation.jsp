...
<title>Hallticket [Student]</title>
<style type="text/css">
body,html {
	margin: 0;
    padding: 0;
...
<form  method="post" action="./studentoperation">

<div class="upperdiv">
	<h3 align="center" style='padding-top:75px;font-size: 20px; color: white' >Welcome <%=Name %></h3>
...
<div class='lowerdiv'>
	...
	<button class='clickbutton2' type="submit" name='action' value='hallticketGeneration'> Generate Hallticket</button>	
