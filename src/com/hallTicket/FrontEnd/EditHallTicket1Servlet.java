...
@WebServlet("/edithallticket1")
public class EditHallTicket1Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Subjecthash.size()==subject.length)
			if(hallops.updatehallticket(department,year,semester,subject,theory,practical,oral)) {
			...
			out.println("<html><body><div align=\"center\" style=\"margin:2in; background-color:'grey; '\"><h3 style='color:Green;font-size:20px; '>Hallticket Updated Successful.</h3></body></html>");
			}else {
				request.getRequestDispatcher("/TeacherOperation.jsp").include(request, response);
